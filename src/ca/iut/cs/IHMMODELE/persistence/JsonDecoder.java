...
{
	private static final String PREFIX_DIAGRAMS = "ca.iut.cs.IHMMODELE.diagrams.";
	private static final String PREFIX_NODES = "ca.iut.cs.IHMMODELE.graph.nodes.";
	private static final String PREFIX_EDGES = "ca.iut.cs.IHMMODELE.graph.edges.";
