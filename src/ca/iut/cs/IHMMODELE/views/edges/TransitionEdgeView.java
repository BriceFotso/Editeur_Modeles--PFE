 ...
 * 
 */
public class TransitionEdgeView extends AbstractEdgeView
{
	 ...
	 */
	public TransitionEdgeView(TransitionEdge pEdge) // should be labeled edge
	{
		super(pEdge);
	}
	
	@Override
	public TransitionEdge edge() // fix when edge hierarchy final
	{
		return (TransitionEdge)super.edge();
	}
