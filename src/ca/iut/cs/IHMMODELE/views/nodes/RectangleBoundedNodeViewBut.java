 ...
 *
 */
public abstract class RectangleBoundedNodeViewBut extends AbstractNodeViewBut
{
	 ...
	 */
	protected RectangleBoundedNodeViewBut(Node pNode, int pMinWidth, int pMinHeight)
	{
		super(pNode);
		aWidth = pMinWidth;
		aHeight = pMinHeight;
