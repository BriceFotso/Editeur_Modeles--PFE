 ...
 *
 */
public abstract class RectangleBoundedNodeViewText extends AbstractNodeViewText
{
	 ...
	 */
	protected RectangleBoundedNodeViewText(Node pNode, int pMinWidth, int pMinHeight)
	{
		super(pNode);
		aWidth = pMinWidth;
		aHeight = pMinHeight;
